...
/** The same tooltip, centred under its button instead of lined up with the button's right edge: for buttons that are not at the edge. On a phone it stays lined up with the right edge: centred, a wide label would stick out past the screen and make the page scroll sideways. */
export const TOOLTIP_CENTERED_CLASS = TOOLTIP_CLASS.replace("right-0", "right-0 sm:right-auto sm:left-1/2 sm:-translate-x-1/2");
